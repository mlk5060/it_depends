...
module ItDepends
  class << self
    ...
    def setup(app_directory)
      ...
      get_all_files_in_app_directory(app_directory).each do |app_file|
    ...
    def get_all_files_in_app_directory(app_directory)
      Dir[app_directory + ALL_RUBY_FILES_IN_APP_DIRECTORY]
    end
    ...
    # TODO: add support for profile switches.
